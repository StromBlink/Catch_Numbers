...
namespace Voodoo.Visual.UI
{
    ...
    {
        [MenuItem("Voodoo/EasyAnchors/Anchors to Corners %[")]
        ...
        [MenuItem("Voodoo/EasyAnchors/Corners to Anchors %]")]
        ...
        [MenuItem("Voodoo/EasyAnchors/Mirror Horizontally Around Anchors %;")]
        static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }

        [MenuItem("Voodoo/EasyAnchors/Mirror Horizontally Around Parent Center %:")]
        ...
        [MenuItem("Voodoo/EasyAnchors/Mirror Vertically Around Anchors %'")]
        static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }

        [MenuItem("Voodoo/EasyAnchors/Mirror Vertically Around Parent Center %\"")]
